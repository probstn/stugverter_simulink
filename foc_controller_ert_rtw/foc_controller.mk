###########################################################################
## Makefile generated for component 'foc_controller'. 
## 
## Makefile     : foc_controller.mk
## Generated on : Mon Aug 24 14:39:48 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/foc_controller.exe
...
COMPILER_COMMAND_FILE     = foc_controller_comp.rsp
CMD_FILE                  = foc_controller.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/foc_controller.exe
...
DEFINES_STANDARD = -DMODEL=foc_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/foc_controller_ert_rtw/foc_controller.c $(START_DIR)/foc_controller_ert_rtw/foc_controller_data.c $(START_DIR)/foc_controller_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/foc_controller_ert_rtw/ert_main.c
...
OBJS = foc_controller.obj foc_controller_data.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/foc_controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/foc_controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/foc_controller_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/foc_controller_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/foc_controller_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(START_DIR)/foc_controller_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


foc_controller.obj : $(START_DIR)/foc_controller_ert_rtw/foc_controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"


foc_controller_data.obj : $(START_DIR)/foc_controller_ert_rtw/foc_controller_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/foc_controller_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
